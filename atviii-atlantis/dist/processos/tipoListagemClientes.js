...
const listagemTodosDependentes_1 = __importDefault(require("./listagemTodosDependentes"));
const listagemTitularEspecifico_1 = __importDefault(require("./listagemTitularEspecifico"));
    ...
    processar() {
        ...
        switch (this.opcao) {
            case 1:
                ...
                break;
            case 2:
                this.processo = new listagemTodosDependentes_1.default();
                this.processo.processar();
                break;
            case 3:
                this.processo = new listagemTitularEspecifico_1.default();
                this.processo.processar();
                break;
            default:
