...
const cadastroCelular_1 = __importDefault(require("./cadastroCelular"));
class CadastroClienteTitular extends processo_1.default {
    processar() {
        ...
        let cliente = new cliente_1.default(nome, nomeSocial, dataNascimento, false);
        this.processo = new cadastroEnderecoTitular_1.default(cliente);
        this.processo.processar();
        this.processo = new cadastroCelular_1.default(cliente);
        this.processo.processar();
        let vazio = false;
        while (!vazio) {
