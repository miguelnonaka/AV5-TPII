...
class CadastroPassporte extends processo_1.default {
    constructor(cliente) {
        super();
    ...
    processar() {
        ...
        let rg = new documento_1.default(numero, TipoDocumento_1.TipoDocumento.Passaporte, dataExpedicao);
...
exports.default = CadastroPassporte;
